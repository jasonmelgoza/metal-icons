...
@Component({
  selector: 'metal-icon-airplay-24-solid',
  standalone: true,
  template: `
  ...
  <path d="M10.96 13.561a1.25 1.25 0 0 1 2.08 0l2.996 4.496A1.25 1.25 0 0 1 14.996 20H9.004a1.25 1.25 0 0 1-1.04-1.943l2.995-4.496Z"/>
</svg>
  `,
  styles: [`
    :host {
