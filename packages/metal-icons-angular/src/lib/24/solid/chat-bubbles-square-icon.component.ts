...
@Component({
  selector: 'metal-icon-chat-bubbles-square-24-solid',
  standalone: true,
  template: `
  ...
  <path fill-rule="evenodd" d="M9.75 7A2.75 2.75 0 0 0 7 9.75v7.5A2.75 2.75 0 0 0 9.75 20h8.048c.284 0 .56.097.781.274l3.203 2.562A.75.75 0 0 0 23 22.25V9.75A2.75 2.75 0 0 0 20.25 7H9.75Z" clip-rule="evenodd"/>
</svg>
  `,
  styles: [`
    :host {
