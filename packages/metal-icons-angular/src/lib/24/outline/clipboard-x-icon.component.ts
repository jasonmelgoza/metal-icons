...
@Component({
  selector: 'metal-icon-clipboard-x-24-outline',
  standalone: true,
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
  <path d="M15.78 10.28a.75.75 0 1 0-1.06-1.06L12 11.94 9.28 9.22a.75.75 0 0 0-1.06 1.06L10.94 13l-2.72 2.72a.75.75 0 1 0 1.06 1.06L12 14.06l2.72 2.72a.75.75 0 1 0 1.06-1.06L13.06 13l2.72-2.72Z"/>
