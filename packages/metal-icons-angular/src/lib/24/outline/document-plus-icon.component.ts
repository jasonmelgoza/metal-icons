...
@Component({
  selector: 'metal-icon-document-plus-24-outline',
  standalone: true,
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
  <path d="M11.75 10.75a.75.75 0 0 1 .75.75V14H15a.75.75 0 1 1 0 1.5h-2.5V18a.75.75 0 1 1-1.5 0v-2.5H8.5a.75.75 0 1 1 0-1.5H11v-2.5a.75.75 0 0 1 .75-.75Z"/>
