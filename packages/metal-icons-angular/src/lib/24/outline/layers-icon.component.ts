...
@Component({
  selector: 'metal-icon-layers-24-outline',
  standalone: true,
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
  <path fill-rule="evenodd" d="M11.658 1.082a.75.75 0 0 1 .684 0l10.25 5.25a.75.75 0 0 1 0 1.336l-10.25 5.25a.749.749 0 0 1-.684 0l-10.25-5.25a.75.75 0 0 1 0-1.336l10.25-5.25ZM3.395 7 12 11.407 20.605 7 12 2.593 3.395 7Z" clip-rule="evenodd"/>
