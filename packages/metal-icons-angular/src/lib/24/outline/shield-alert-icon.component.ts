...
@Component({
  selector: 'metal-icon-shield-alert-24-outline',
  standalone: true,
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
  <path d="M12 7a.75.75 0 0 1 .75.75v4.5a.75.75 0 1 1-1.5 0v-4.5A.75.75 0 0 1 12 7Zm0 8a1 1 0 0 0 0 2h.01a1 1 0 1 0 0-2H12Z"/>
