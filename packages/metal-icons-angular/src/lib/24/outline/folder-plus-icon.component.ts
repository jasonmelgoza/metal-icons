...
@Component({
  selector: 'metal-icon-folder-plus-24-outline',
  standalone: true,
  template: `
  ...
  <path d="M12 9.25a.75.75 0 0 1 .75.75v2.25H15a.75.75 0 1 1 0 1.5h-2.25V16a.75.75 0 1 1-1.5 0v-2.25H9a.75.75 0 1 1 0-1.5h2.25V10a.75.75 0 0 1 .75-.75Z"/>
</svg>
  `,
  styles: [`
    :host {
