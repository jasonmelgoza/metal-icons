...
const SvgShoppingCart = (props) => (
  ...
  >
    ...
    />
    <path d="M10.987 21.987A1.75 1.75 0 0 0 9.75 19h-.01a1.75 1.75 0 0 0 0 3.5h.01c.464 0 .91-.184 1.237-.513m10 0A1.75 1.75 0 0 0 19.75 19h-.01a1.75 1.75 0 1 0 0 3.5h.01c.464 0 .91-.184 1.237-.513" />
  </svg>
)
