...
const SvgCircleArrowRight = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M6 12a.75.75 0 0 1 .75-.75h8.614l-3.129-2.955a.75.75 0 0 1 1.03-1.09l4.5 4.25a.75.75 0 0 1 0 1.09l-4.5 4.25a.75.75 0 0 1-1.03-1.09l3.129-2.955H6.75A.75.75 0 0 1 6 12" />
    <path
      fillRule="evenodd"
