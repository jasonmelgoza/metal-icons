...
const SvgEditBox = (props) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M18.45 1.754a2.574 2.574 0 0 1 3.64 0l.156.157a2.574 2.574 0 0 1 0 3.64L10.93 16.868a.75.75 0 0 1-.349.198l-3.648.912a.75.75 0 0 1-.91-.91l.912-3.648a.75.75 0 0 1 .198-.349zm-.917 3.037L8.34 13.985l-.558 2.234 2.234-.558 9.194-9.194-1.676-1.676Zm1.057-1.057 1.686 1.686.949-.949a1.042 1.042 0 0 0 0-1.474l-.212-.212a1.043 1.043 0 0 0-1.474 0z"
    />
