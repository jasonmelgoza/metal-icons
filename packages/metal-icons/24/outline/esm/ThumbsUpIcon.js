...
function ThumbsUpIcon({
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    fillRule: "evenodd",
    d: "M11.23 2.516 7.5 10.909V21.5h10.98a1.25 1.25 0 0 0 1.237-1.062l1.442-9.5A1.25 1.25 0 0 0 19.923 9.5H14.75A1.75 1.75 0 0 1 13 7.75V4.525a2.025 2.025 0 0 0-1.77-2.009M6 21.5v-10H3.75c-.69 0-1.25.56-1.25 1.25v7.5c0 .69.56 1.25 1.25 1.25zM6.263 10l3.71-8.349A1.097 1.097 0 0 1 10.975 1 3.525 3.525 0 0 1 14.5 4.525V7.75c0 .138.112.25.25.25h5.173a2.75 2.75 0 0 1 2.72 3.163l-1.443 9.5A2.75 2.75 0 0 1 18.48 23H3.75A2.75 2.75 0 0 1 1 20.25v-7.5A2.75 2.75 0 0 1 3.75 10z"
  }));
}
